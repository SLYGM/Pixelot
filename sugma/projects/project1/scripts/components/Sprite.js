...
export default class Sprite extends engine.Component {
    static arg_names = ["texAlias", "layer", "z-index", "rotation"];
    static arg_types = [engine.Types.String, engine.Types.String, engine.Types.Number, engine.Types.Number];
    ...
    constructor(texAlias, lr, zi = 0, rotation = 0) {
        super();
        this.tex = texAlias;
        this.zindex = zi;
        this.lr = lr;
